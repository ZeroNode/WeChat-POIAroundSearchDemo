 ...
 *  筛选，查询代理
 */
- (void)menu:(DOPDropDownMenu *)menu doSearch:(NSString *)keyWord;


@end

#pragma mark - interface
@interface DOPDropDownMenu : UIView <UITableViewDataSource, UITableViewDelegate , UISearchBarDelegate >
